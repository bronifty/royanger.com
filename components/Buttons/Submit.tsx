...
const SubmitButton = ({ children, className, submitted }: SubmitButton) => {
   const buttonState = submitted
      ? 'bg-grey-300'
      : 'bg-gradient-to-tr from-grey-700 via-grey-600 to-grey-700 hover:to-yellow-400 hover:via-blue-600 hover:from-blue-900 text-grey-100 dark:bg-grey-300 dark:text-grey-800 dark:hover:bg-grey-100 transform hover:scale-[1.04] transition-all'
