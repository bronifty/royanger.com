...
For some time I used a product called The Productivity Planner. This planner featured a weekly planner where you would outline the large tasks you need to do, a daily planner to focus each day and then a weekly review. The daily planner, in particular, helped me. I could worry about the things I needed to finish in a day and not worry about large task list.
